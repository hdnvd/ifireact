...
class trapp_viewtypeView extends SweetComponent {
    constructor(props) {
        super(props);
        this.state = {
                canEdit:AccessManager.UserCan('trapp','viewtype',AccessManager.EDIT),
    ...
    render(){
        return <MDBContainer>
            <MDBRow>
                <MDBCol md='6'>
                    <form>
                        <p className='h5 text-center mb-4'> viewtype</p>
...
export default trapp_viewtypeView;
