...
export default class trapp_villaownerBalances extends SweetComponent {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    LoadData(pageSize,page,sorted,filtered)
    {
        ...
        let url='/trapp/villaownerbalances'+filterAndSortString;
...
{
    Header: 'کد ملی',
    accessor: 'nationalcode_bnum'
},
{
    Header: 'کد شبا',
    accessor: 'shabacode_bnum'
},
    {
        Header: 'تلفن',
        accessor: 'tel_bnum'
