...
class sas_requestmessageView extends SweetComponent {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render(){
        return <MDBContainer>
            <MDBRow>
                <MDBCol md='6'>
                    <form>
                        <p className='h5 text-center mb-4'> requestmessage</p>
                        
                        <div className='form-group'>
                            <label>message_te</label>
                            <label
                                className='valuelabel'>
                                {this.state.messagete}
                            </label>
                        </div>
                        <div className='form-group'>
                            <label>درخواست</label>
...
export default sas_requestmessageView;
