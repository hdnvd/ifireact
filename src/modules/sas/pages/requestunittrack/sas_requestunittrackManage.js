...
class sas_requestunittrackManage extends SweetComponent {
    constructor(props) {
        super(props);
        this.state = {
                canEdit:AccessManager.UserCan('sas','requestunittrack',this.props.match.params.id>0?AccessManager.EDIT:AccessManager.INSERT),
        ...
        data => {
            data.Data=Common.convertNullKeysToEmpty(data.Data);
                 ...
                 this.setState({ request:data.Data.request,unit:data.Data.unit,user:data.Data.user,});
            }, 
    ...
    render(){
        return <MDBContainer>
            <MDBRow>
                <MDBCol md='6'>
                    <form>
                        <p className='h5 text-center mb-4'>تعریف requestunittrack</p>
                        ...
                        <select 
                            ...
                            {this.state.canEdit && 
								...
								if(id!==''){
                                    ...
                                    new SweetFetcher().Fetch('/sas/requestunittrack'+Separator+id,method,data, 
                                    res => {
                                                return this.props.history.push('/sas/requestunittracks');
                                                //console.log(res);
                                        },(error)=>{
...
export default sas_requestunittrackManage;
