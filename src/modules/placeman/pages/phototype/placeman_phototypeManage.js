...
class placeman_phototypeManage extends SweetComponent {
    constructor(props) {
        super(props);
        this.state = {
                canEdit:AccessManager.UserCan('placeman','phototype',this.props.match.params.id>0?AccessManager.EDIT:AccessManager.INSERT),
    ...
    render(){
        return <MDBContainer>
            <MDBRow>
                <MDBCol md='6'>
                    <form>
                        <p className='h5 text-center mb-4'>تعریف phototype</p>
                        ...
                        <div className='form-group'>
                            ...
                            {this.state.canEdit && 
								...
								if(id!==''){
                                    ...
                                    new SweetFetcher().Fetch('/placeman/phototype'+Separator+id,method,data, 
                                    res => {
                                                return this.props.history.push('/placeman/phototypes');
                                                //console.log(res);
                                        },(error)=>{
...
export default placeman_phototypeManage;
