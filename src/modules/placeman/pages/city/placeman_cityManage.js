...
class placeman_cityManage extends SweetComponent {
    constructor(props) {
        super(props);
        this.state = {
                canEdit:AccessManager.UserCan('placeman','city',this.props.match.params.id>0?AccessManager.EDIT:AccessManager.INSERT),
        ...
        data => {
            data.Data=Common.convertNullKeysToEmpty(data.Data);
                 ...
                 this.setState({ title:data.Data.title,province:data.Data.provinceid,});
            },
    ...
    render(){
        return <MDBContainer>
            <MDBRow>
                <MDBCol md='6'>
                    <form>
                        <p className='h5 text-center mb-4'>تعریف شهر</p>
                        ...
                        <select
                            ...
                            {this.state.canEdit &&
								...
								if(id!==''){
                                    ...
                                    new SweetFetcher().Fetch('/placeman/city'+Separator+id,method,data,
                                    res => {
                                                return this.props.history.push('/placeman/citys');
                                                //console.log(res);
                                        },(error)=>{
...
export default placeman_cityManage;
