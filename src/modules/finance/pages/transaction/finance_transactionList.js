...
class finance_transactionList extends SweetComponent {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
            ...
            canInsert:AccessManager.UserCan('finance','transaction',AccessManager.INSERT),
            canDelete:AccessManager.UserCan('finance','transaction',AccessManager.DELETE),
    ...
    LoadData(pageSize,page,sorted,filtered)
    {
        ...
        let url='/finance/transaction'+filterAndSortString;
        ...
        null,'finance.transaction',AccessManager.LIST,
        this.props.history);
...
new SweetFetcher().Fetch('/finance/user',SweetFetcher.METHOD_GET,null,
    ...
    render(){
        return <div className={'pagecontent'}>
                    ...
                    <MDBModalBody>
                        ...
                        <div className='form-group'>
                            ...
                            <input
                                ...
                                id='amountprc'
                                type='text'
                                onChange={(event)=>{this.searchParams.amountprc=event.target.value;}}/>
                        </div>
                        <div className='form-group'>
                            ...
                            <input
                                ...
                                id='transactionid'
                                type='text'
                                onChange={(event)=>{this.searchParams.transactionid=event.target.value;}}/>
                        </div>
                        <div className='form-group'>
            ...
            <div className={'topoperationsrow'}>{this.state.canInsert && <Link className={'addlink'}  to={'/finance/transactions/management'}><IoMdAddCircle/></Link>}</div>
        <SweetTable
            filterable={false}
...
},
{
    ...
    Cell: props => <div className={'operationsrow'}>
                   {/*{!this.state.canEdit &&*/}
                    {/*<Link className={'viewlink'}  to={'/finance/transactions/view/'+props.value}><IoMdEye/></Link>*/}
                   {/*}*/}
                   {/*{this.state.canEdit &&*/}
                    {/*<Link className={'editlink'}  to={'/finance/transactions/management/'+props.value}><FaEdit/></Link>*/}
                   {/*}*/}
                   {/*{this.state.canDelete &&*/}
                       {/*<MdDeleteForever onClick={ */}
                       {/*() =>{*/}
                         {/*SweetAlert.displayDeleteAlert(()=>{*/}
                            {/*new SweetFetcher().Fetch('/finance/transaction/' + props.value, SweetFetcher.METHOD_DELETE, null,*/}
                                {/*data => {*/}
                                ...
                                {/*},(error)=>{*/}
                                        ...
                                        {/*},'finance.transaction',AccessManager.DELETE,this.props.history);*/}
                         {/*});*/}
                        {/*}*/}
                        {/*}/>*/}
                 {/*}*/}
...
export default finance_transactionList;
