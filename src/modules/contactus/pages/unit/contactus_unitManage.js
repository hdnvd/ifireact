...
class contactus_unitManage extends SweetComponent {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render(){
        return <MDBContainer>
            <MDBRow>
                <MDBCol md='6'>
                    <form>
                        <p className='h5 text-center mb-4'>تعریف unit</p>
                        ...
                        <div className='form-group'>
                            ...
                            {this.state.canEdit && 
								...
								if(id!==''){
                                    ...
                                    new SweetFetcher().Fetch('/contactus/unit'+Separator+id,method,data, 
                                    res => {
                                                return this.props.history.push('/contactus/units');
                                                //console.log(res);
                                        },(error)=>{
...
export default contactus_unitManage;
